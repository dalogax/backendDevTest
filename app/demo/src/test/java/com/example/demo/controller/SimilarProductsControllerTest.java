...
public class SimilarProductsControllerTest {
    ...
    private String productSimilarIdFormat = "/product/%s/similarids",
            urlLocalhostProductIdSimilar = "http://localhost:%s/product/%s/similar";
    ...
    public void shouldReturnStatus404_WhenSimilarProductIdsNotFound() {
        ...
        // given
        wireMockServer.stubFor(WireMock.get(urlPathMatching(String.format(productSimilarIdFormat, productId)))
        ...
        final ResponseEntity<String> response = this.testRestTemplate.getForEntity(
                String.format(urlLocalhostProductIdSimilar, port, productId),
                String.class);
    ...
    public void shouldReturnStatus404_WhenSimilarProductNotFound() {
        ...
        // given
        stubInWireMockServer(String.format(productSimilarIdFormat, productId), asJson(givenSimilarProductIds));
